    ...
    <section data-nav-theme="dark" className="section-dark h-screen flex items-center">
      <div className="w-full px-[5vw]">
        ...
        <div className="max-w-[60vw] mx-auto text-center mb-[4vh]">
          <ScrollReveal>
            <p className="text-[calc(1.25*var(--vf))] text-dark-muted leading-relaxed mb-[2vh]">
          ...
          <ScrollReveal>
            <p className="text-[calc(1.25*var(--vf))] text-dark-muted leading-relaxed mb-[3vh]">
              今すぐ、あたらしいAIを手に入れよう。
            </p>
          </ScrollReveal>
          <ScrollReveal>
        ...
        {/* Features heading */}
        <ScrollReveal>
          <h3 className="text-[calc(2*var(--vf))] font-bold text-dark-fg mt-[4vh] mb-[3vh]">
            UNCHAINの特徴
          </h3>
        </ScrollReveal>
          ...
          {features.map((feature, i) => {
            ...
            return (
              ...
              >
                ...
                >
                  <span className="text-[calc(1*var(--vf))] font-bold text-dark-fg mb-[2vh]">
                    {feature.num}
                  </span>
                  ...
                  <h4 className="text-[calc(1*var(--vf))] font-bold text-dark-fg mb-[0.5vh] whitespace-pre-line text-center">
                    {feature.title}
                  </h4>
                  <p className="text-[calc(0.875*var(--vf))] text-dark-muted leading-relaxed text-center">
                    {feature.desc}
                  </p>
                </div>
              </ScrollReveal>
