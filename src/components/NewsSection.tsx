    ...
    <section id="news" data-nav-theme="light" className="bg-background h-[70vh] flex items-center overflow-hidden">
      <div className="w-full px-[5vw]">
        ...
        <div className="flex items-center justify-between mb-[3vh]">
          <ScrollReveal>
            <h2 className="text-[calc(3.75*var(--vf))] font-bold text-foreground">
              NEWS
            </h2>
          </ScrollReveal>
          ...
          >
            {newsItems.map((item, i) => (
              ...
              >
                ...
                <p className="text-[calc(1.125*var(--vf))] font-medium mb-[0.5vh] line-clamp-2 text-foreground">
                  {item.title}
                </p>
                <p className="text-[calc(0.875*var(--vf))] text-muted-foreground line-clamp-1">
                  {item.subtitle}
                </p>
              </a>
            ))}
        ...
        <ScrollReveal className="text-center mt-[3vh]">
          <a
            href="#"
            className="text-[calc(1*var(--vf))] font-medium text-muted-foreground hover:text-foreground transition-colors underline underline-offset-4"
          >
            すべて見る
          </a>
        </ScrollReveal>
