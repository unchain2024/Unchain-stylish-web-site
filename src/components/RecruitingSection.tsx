    ...
    >
      <div className="w-full px-[5vw]">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-[4vw] items-center">
          ...
          <div>
            <ScrollReveal>
              <p className="text-primary text-[clamp(0.75rem,1vw,1rem)] font-semibold tracking-wider mb-[2vh]">
                Join UNCHAIN
              </p>
            </ScrollReveal>
            <ScrollReveal>
              <h2 className="text-[clamp(1.75rem,4vw,4.5rem)] font-bold text-white leading-tight mb-[2vh]">
                未来を創る
                <br />
                AIの先駆者になろう
              </h2>
            ...
            <ScrollReveal>
              <p className="text-white/70 text-[clamp(0.8rem,1vw,1.125rem)] leading-relaxed mb-[3vh] max-w-[35vw]">
            ...
            <ScrollReveal>
              <a href="#" className="btn-cta inline-flex items-center gap-[0.5vw] text-[clamp(0.75rem,1vw,1rem)]"
